...
final class TopupRoutingMock: TopupRouting {
  ...
  var dettachAddPaymentMethodCallCount = 0
  func dettachAddPaymentMethod() {
    dettachAddPaymentMethodCallCount += 1
  }
  ...
  var dettachCardOnFileCallCount = 0
  func dettachCardOnFile() {
    dettachCardOnFileCallCount += 1
  }
...
final class TopupInteractableMock: TopupInteractable {
  ...
  var cardOnFileDidTapAddNewCardCallCount = 0
  func cardOnFileDidTapAddNewCard() {
    cardOnFileDidTapAddNewCardCallCount += 1
  }
